...
def run_ga(experiment_name, structure_shape, pop_size, max_evaluations, train_iters, num_cores, voxels_pd=None, voxels_limits=None, structure_requirement=None):
    print()
    ...
    if not is_continuing: 
        for i in range (pop_size):
            ...
            temp_structure = sample_robot(structure_shape, pd=voxels_pd, limits=voxels_limits, structure_requirement=structure_requirement,)
    ...
    while True:
        ...
        while num_children < (pop_size - num_survivors) and num_evaluations < max_evaluations:
            ...
            child = mutate(survivors[parent_index[0]].body.copy(), mutation_rate = 0.1, num_attempts=50, pd=voxels_pd, limits=voxels_limits, structure_requirement=structure_requirement)
